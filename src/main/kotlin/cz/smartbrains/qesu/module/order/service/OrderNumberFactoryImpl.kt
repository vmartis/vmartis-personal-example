...
@Service
class OrderNumberFactoryImpl(private val orderRepository: OrderRepository) : OrderNumberFactory {
    override fun nextNumber(year: Int): BigInteger {
        ...
        val currentNumber = orderRepository.findLastByNumber(nowYearStart, nowYearEnd)
